...
/**
 ...
 [super viewDidLoad];
	// Do any additional setup after loading the view, typically from a nib.
 UIImageView *_image1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.png"]];
 _image1.frame = CGRectMake(75.0, 115.0, 45.0, 45.0);
 image1 = _image1;
 [self.view addSubview:_image1];
 UIImageView *_image2 = [[U IImageView alloc] initWithImage:[UIImage imageNamed:@"2.png"]];
 _image2.frame = CGRectMake(135.0, 115.0, 45.0, 45.0);
 image2 = _image2;
 [self.view addSubview:_image2];
 UIImageView *_image3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"3.png"]];
 _image3.frame = CGRectMake(195.0, 115.0, 45.0, 45.0);
 image3 = _image3;
 [self.view addSubview:_image3];
 UIImageView *_image4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"4.png"]];
 _image4.frame = CGRectMake(80.0, 180.0, 45.0, 45.0);
 image4 = _image4;
 [self.view addSubview:_image4];
 UIImageView *_image5 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"5.png"]];
 _image5.frame = CGRectMake(140.0, 180.0, 45.0, 45.0);
 image5 = _image5;
 [self.view addSubview:_image5];
 UIImageView *_image6 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"6.png"]];
 ...
 switch (result1) {
 case 1:
 dong1.image = [UIImage imageNamed:@"1.png"];
 break;
 case 2:
 dong1.image = [UIImage imageNamed:@"2.png"];
 break;
 case 3:
 dong1.image = [UIImage imageNamed:@"3.png"];
 break;
 case 4:
 dong1.image = [UIImage imageNamed:@"4.png"];
 break;
 case 5:
 dong1.image = [UIImage imageNamed:@"5.png"];
 break;
 case 6:
 dong1.image = [UIImage imageNamed:@"6.png"];
 break;
 }
 //骰子2的结果
 int result2 = (rand() % 5) +1 ;  //产生1～6的数
 switch (result2) {
 case 1:dong2.image = [UIImage imageNamed:@"1.png"];break;
 case 2:dong2.image = [UIImage imageNamed:@"2.png"];break;
 case 3:dong2.image = [UIImage imageNamed:@"3.png"];break;
 case 4:dong2.image = [UIImage imageNamed:@"4.png"];break;
 case 5:dong2.image = [UIImage imageNamed:@"5.png"];break;
 case 6:dong2.image = [UIImage imageNamed:@"6.png"];break;
 }
 //骰子3的结果
 int result3 = (rand() % 5) +1 ;  //产生1～6的数
 switch (result3) {
 case 1:dong3.image = [UIImage imageNamed:@"1.png"];break;
 case 2:dong3.image = [UIImage imageNamed:@"2.png"];break;
 case 3:dong3.image = [UIImage imageNamed:@"3.png"];break;
 case 4:dong3.image = [UIImage imageNamed:@"4.png"];break;
 case 5:dong3.image = [UIImage imageNamed:@"5.png"];break;
 case 6:dong3.image = [UIImage imageNamed:@"6.png"];break;
 }
 //骰子4的结果
 int result4 = (rand() % 5) +1 ;  //产生1～6的数
 switch (result4) {
 case 1:dong4.image = [UIImage imageNamed:@"1.png"];break;
 case 2:dong4.image = [UIImage imageNamed:@"2.png"];break;
 case 3:dong4.image = [UIImage imageNamed:@"3.png"];break;
 case 4:dong4.image = [UIImage imageNamed:@"4.png"];break;
 case 5:dong4.image = [UIImage imageNamed:@"5.png"];break;
 case 6:dong4.image = [UIImage imageNamed:@"6.png"];break;
 }
 //骰子5的结果
 int result5 = (rand() % 5) +1 ;  //产生1～6的数
 switch (result5) {
 case 1:dong5.image = [UIImage imageNamed:@"1.png"];break;
 case 2:dong5.image = [UIImage imageNamed:@"2.png"];break;
 case 3:dong5.image = [UIImage imageNamed:@"3.png"];break;
 case 4:dong5.image = [UIImage imageNamed:@"4.png"];break;
 case 5:dong5.image = [UIImage imageNamed:@"5.png"];break;
 case 6:dong5.image = [UIImage imageNamed:@"6.png"];break;
 }
 //骰子6的结果
 int result6 = (rand() % 5) +1 ;  //产生1～6的数
 switch (result6) {
 case 1:
 dong6.image = [UIImage imageNamed:@"1.png"];
 break;
 case 2:dong6.image = [UIImage imageNamed:@"2.png"];break;
 case 3:dong6.image = [UIImage imageNamed:@"3.png"];break;
 case 4:dong6.image = [UIImage imageNamed:@"4.png"];break;
 case 5:dong6.image = [UIImage imageNamed:@"5.png"];break;
 case 6:dong6.image = [UIImage imageNamed:@"6.png"];break;
 }
 }
 */
